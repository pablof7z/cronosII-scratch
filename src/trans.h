...
gchar *s = N_("Open the Address Book");
gchar *s = N_("Contacts.");
gchar *s = N_("Close CronosII");
gchar *s = N_("Exit");
gchar *s = N_("Mailbox");
gchar *s = N_("Message List");
...
gchar *s = N_("Cronos II is a fast, light, user friendly and powerful mail client for you and the Gnome Desktop.\n"
              "It has an extended and intuitive interface which  makes  for  easier use while remaining extensible for you as your experience grows.\n"
              " \n"
