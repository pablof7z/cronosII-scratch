...
c2_config_init (void)
{
	...
	tmp = gnome_config_get_string ("/Cronos II/Cronos II/Version");
	if (!tmp)
	{
#if FALSE /* TODO */
		gdk_threads_enter ();
	...
	c2_app.rc_hpan = gnome_config_get_int_with_default ("/Cronos II/Rc/hpan=" DEFAULT_RC_HPAN, NULL);
	c2_app.rc_vpan = gnome_config_get_int_with_default ("/Cronos II/Rc/vpan=" DEFAULT_RC_VPAN, NULL);
	c2_app.rc_clist[0] = gnome_config_get_int_with_default ("/Cronos II/Rc/clist[0]=" DEFAULT_RC_CLIST_0, NULL);
	c2_app.rc_clist[1] = gnome_config_get_int_with_default ("/Cronos II/Rc/clist[1]=" DEFAULT_RC_CLIST_1, NULL);
	c2_app.rc_clist[2] = gnome_config_get_int_with_default ("/Cronos II/Rc/clist[2]=" DEFAULT_RC_CLIST_2, NULL);
	c2_app.rc_clist[3] = gnome_config_get_int_with_default ("/Cronos II/Rc/clist[3]=" DEFAULT_RC_CLIST_3, NULL);
	c2_app.rc_clist[4] = gnome_config_get_int_with_default ("/Cronos II/Rc/clist[4]=" DEFAULT_RC_CLIST_4, NULL);
	c2_app.rc_clist[5] = gnome_config_get_int_with_default ("/Cronos II/Rc/clist[5]=" DEFAULT_RC_CLIST_5, NULL);
	c2_app.rc_clist[6] = gnome_config_get_int_with_default ("/Cronos II/Rc/clist[6]=" DEFAULT_RC_CLIST_6, NULL);
	c2_app.rc_clist[7] = gnome_config_get_int_with_default ("/Cronos II/Rc/clist[7]=" DEFAULT_RC_CLIST_7, NULL);
	c2_app.rc_width = gnome_config_get_int_with_default ("/Cronos II/Rc/width=" DEFAULT_RC_WIDTH, NULL);
	c2_app.rc_height = gnome_config_get_int_with_default ("/Cronos II/Rc/height=" DEFAULT_RC_HEIGHT, NULL);
