...
enum _C2DialogPreferencesKey
{
	...
	C2_DIALOG_PREFERENCES_KEY_GENERAL_OPTIONS_OUTGOING_WRAP,
	C2_DIALOG_PREFERENCES_KEY_GENERAL_OPTIONS_OUTGOING_OUTBOX,
...
{
	C2_DIALOG_PREFERENCES_SUBSECTION_GENERAL_OPTIONS,
