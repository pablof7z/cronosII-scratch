...
gchar *s = N_("label76");
gchar *s = N_("[ Cronos II's logo ]");
gchar *s = N_("Through this dialog you will be able to configure Cronos II to behave the way you want it too.\n"
              "\n"
              "When you don't know what a field is for, you can get help by keeping your mouse for a couple of seconds over it, then a little help will pop-up describing what that field is all about.\n"
              "\n"
              "If you need extra help you should get in touch with other users or with the developers.\n"
              "To have the information of how to get in touch you should click on 'Getting in Touch' in the Help menu of the main window.");
gchar *s = N_("General");
