...
not valid.", 336},
  ...
  {"_Contact", 343},
  {"Open a new main window", 344},
  {"_Window", 345},
  {"_Check Mail", 346},
  {"Check all accounts for new mail", 347},
  {"All Accounts", 348},
  {"_Send unsent mails", 349},
  {"Open the Address Book", 350},
  {"_Address Book", 351},
  {"_Save", 352},
  {"_Print", 353},
  {"mmmm, I smell a nice egg coming from the east...", 354},
  {"_From", 355},
  {"_Account", 356},
  {"_To", 357},
  {"_Carbon Copy", 358},
  {"_Blind Carbon Copy", 359},
  {"_Date", 360},
  {"_Subject", 361},
  {"_Priority", 362},
  {"_Mailbox", 363},
  ...
  {"Reply _all", 370},
  {"_Forward", 371},
  {"Copy selected messages", 372},
  {"_Copy", 373},
  {"Move selected messages", 374},
  {"_Move", 375},
  {"Delete selected messages", 376},
  {"_Delete", 377},
  {"Expunge selected messages", 378},
  {"_Expunge", 379},
  {"Mar_k", 380},
  {"Mark selected message as important", 381},
  {"_Important", 382},
  {"Mark selected messages as unreaded", 383},
  {"_Unread", 384},
  {"Mark selected messages as readed", 385},
  {"_Read", 386},
  {"Mark selected messages as replied", 387},
  {"Repl_ied", 388},
  {"Mark selected messages as forwarded", 389},
  {"_Previous", 390},
  {"_Next", 391},
  {"Try to recover an expunged message", 392},
  {"Reco_very", 393},
  {"_User Manual", 394},
  {"_Quick Tips", 395},
  {"_Getting in Touch", 396},
  {"_Release Information", 397},
  {"About _Plugins", 398},
  {"Icon Menu Bar", 399},
  {"View Message Pane", 400},
  {"Show the Message Transfer dialog", 401},
  {"\
The mailbox name you\n\
entered is invalid.", 402},
  {"close this dialog", 403},
  {"Mailbox properties", 404},
  {"finished", 405},
  {"Warning", 406},
  {"\
Editing mailbox properties might\n\
result in the lost of all mails in it.", 407},
  {"Type here the name of the new mailbox", 408},
  {"Type:", 409},
  {"Select the type of access you want for this mailbox", 410},
  {"Extra data", 411},
  {"Type here the port where this mailbox is stored", 412},
  {"Type here the hostname where this mailbox is stored", 413},
  {"Password:", 414},
  {"Path:", 415},
  {"Select file", 416},
  {"C2 Addressbook", 417},
